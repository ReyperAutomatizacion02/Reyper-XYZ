...
export function ProjectsTable({ projects, onSelectProject, selectedProjectId, sortBy, sortOrder, onSort }: ProjectsTableProps) {
                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCell className="pr-6 py-4 text-right">
                                    <Badge variant="secondary" className="bg-blue-50 dark:bg-blue-900/10 text-blue-600 dark:text-blue-400 border-none shadow-none px-2.5 py-1 font-bold text-[10px] uppercase">
