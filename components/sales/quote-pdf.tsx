...
// Main Component
export function QuotePDF({ data, items }: { data: QuotePDFData; items: QuotePDFItem[] }) {
    ...
    const taxPercent = taxRate > 1 ? taxRate : taxRate * 100;
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <Text style={styles.introText}>
                    De acuerdo a su amable solicitud, tenemos el gusto de cotizarles los artículos que a continuación se
                    detallan.
                </Text>
                ...
                <View style={styles.totalsContainer}>
                    ...
                    <View style={dynamicStyles.grandTotalBox}>
                        ...
                        <Text style={{ fontWeight: "bold" }}>{formatCurrency(totalWithTax, currency)}</Text>
                    </View>
                </View>
                ...
                <View style={styles.footerterms}>
                    ...
                    <Text style={styles.termText}>
                        <Text style={{ fontWeight: "bold" }}>PRECIO UNITARIO:</Text> MÁS I.V.A
                    </Text>
                    <Text style={styles.termText}>
                        <Text style={{ fontWeight: "bold" }}>GARANTÍA:</Text> {isInversa ? "INVERSA" : "REYPER"}{" "}
                        garantiza por un año los productos contra defectos de fabricación bajo condiciones normales de
                        operación.
                    </Text>
                    <Text style={styles.termText}>
                        <Text style={{ fontWeight: "bold" }}>CANCELACIÓN:</Text> Requiere consentimiento escrito. Cargo
                        del 30% por gastos efectuados y 50% en equipo especial.
                    </Text>
                    <Text style={styles.termText}>
                        <Text style={{ fontWeight: "bold" }}>DEVOLUCIÓN:</Text> No se aceptan devoluciones después de 5
                        días hábiles de entregado el material.
                    </Text>
                </View>
