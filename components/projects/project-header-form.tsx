                ...
                {isEditing ? (
                    <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        <Input
                            ...
                            maxLength={100}
                            className="text-lg font-bold uppercase h-11 bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 focus:ring-[#EC1C21] rounded-xl shadow-sm truncate"
                            ...
                            {!hiddenFields.includes('start_date') && (
                                <div className="flex-1">
                                    ...
                                    <Popover>
                                        ...
                                        {!readOnlyFields.includes('start_date') && (
                            ...
                            {!hiddenFields.includes('delivery_date') && (
                                <div className="flex-1">
                                    ...
                                    <Popover>
                                        ...
                                        {!readOnlyFields.includes('delivery_date') && (
                                            <PopoverContent className="w-auto p-0" align="start">
                                                <CalendarUI
                                                    mode="single"
