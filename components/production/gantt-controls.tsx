...
export interface GanttStartControlsProps {
    viewMode: "hour" | "day" | "week";
    onViewModeChange: (mode: "hour" | "day" | "week") => void;
}

export interface GanttEndControlsProps {
    searchQuery: string;
...
export function GanttStartControls({ viewMode, onViewModeChange }: GanttStartControlsProps) {
    return (
        <div
...
export function GanttEndControls({
    searchQuery,
    onSearchChange,
    allMachineNames,
    selectedMachines,
    ...
    const filteredMachineNames = allMachineNames
    ...
    return (
        <div className="flex items-center gap-1.5">
                                                    ...
                                                    {[
                                                        {
                                                            ...
                                                            toggle: () => onShowDependenciesChange(!showDependencies),
                                                        },
                                                        {
                                                            label: "Máquinas Vacías",
                                                            desc: "Ocultar si no tienen tareas",
                                                            value: hideEmptyMachines,
                                                            toggle: () => onHideEmptyMachinesChange(!hideEmptyMachines),
                                                        },
                                                        {
                                                            label: "Modo Cascada",
            ...
            <div className="flex items-center gap-1 rounded-lg border border-border/50 bg-muted/30 p-0.5">
                ...
                >
                    <span className="text-[10px] font-bold text-muted-foreground">{Math.round(zoomLevel * 100)}%</span>
                </div>
                <button
